...
public class ReconOutput_Backup {
	...
	public ReconOutput_Backup() {

	}

	public ReconOutput_Backup(String reportId, String reportName, String reportingDate, Date reconTime,
